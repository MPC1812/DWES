...
<h1>Tarea de <span id="PROF">PROFESOR</span></h1>

<div id="listaLibros">
    //GENERAR AQUÍ LISTA DE LIBROS
</div>

<input type="button" value="Actualizar lista de libros" onclick="alert('Invocar aquí la operación JAXON-JS para actualizar la lista de libros')";>
...
<form id="nuevoLibro" onSubmit="return false;">
    ...
    <BR>
    <input type="button"
        onclick="alert('Invocar aquí la operación JAXON-JS para crear el libro')";
